      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            // Sửa logic lấy field 'message' hoặc 'text' tùy theo model của bạn
            ...
            child: isImage 
              ? ClipRRect(
                  ...
                  child: GestureDetector(
                    // --- ĐÂY LÀ CHỨC NĂNG CLICK ĐỂ PHÓNG TO ---
                    onTap: () => FullScreenImageViewer.open(context, [text]),
                    child: Container(
                      // --- ĐÂY LÀ PHẦN CUSTOM KÍCH THƯỚC ẢNH ---
                      constraints: const BoxConstraints(
                        maxWidth: 200,  // Chiều rộng tối đa của ảnh
                        maxHeight: 200, // Chiều cao tối đa của ảnh
                        minWidth: 100,  // Chiều rộng tối thiểu
                      ),
                      color: Colors.grey[200], // Màu nền trong lúc chờ tải
                      child: Image.network(
                        text,
                        // BoxFit.contain giúp hiện toàn bộ ảnh mà không bị cắt
                        fit: BoxFit.contain,
